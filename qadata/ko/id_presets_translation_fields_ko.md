...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|통행| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|알 수 없음|last|
|access_simple|1|combo|Access|통행| | |access| | | |yes|예|last|
|access_toilets|1|combo|Access|접근| | |access| | | | | |last|
|address|1|address|Address|주소|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|관리 수준| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|유형| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|접근| | |aerialway:access|entry|Entry|입구| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|출구| | |last|
|aerialway/access|3|combo| | | | | |both|Both|둘 다| | |last|
|aerialway/bubble|1|check|Bubble| | | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|수용량 (시간당)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|소요 시간 (분)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated| | | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|무게| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|접근 (여름)| | |aerialway:summer:access|entry|Entry|입구| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|출구| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|둘 다| | |last|
|aeroway|1|typeCombo|Type|유형| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|유형| | |amenity| | | | | |last|
|artist|1|text|Artist|예술가| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|유형| | |artwork_type| | | | | |last|
|atm|1|check|ATM|ATM| | |atm| | | | | |last|
|backrest|1|check|Backrest|등받이| | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|유형| | |barrier| | | | | |last|
|bench|1|check|Bench|벤치| | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|유형| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|유형| | |boundary| | | | | |last|
|brand|1|text|Brand|상표| | |brand| | | | | |last|
|building|1|typeCombo|Building|건물| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|건물| | |building| | | | | |last|
|capacity|1|number|Capacity|수용량| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|방향| | |direction|N|North|북| | |last|
|cardinal_direction|2|combo| | | | | |E|East|동| | |last|
|cardinal_direction|3|combo| | | | | |S|South|남| | |last|
|cardinal_direction|4|combo| | | | | |W|West|서| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|북동| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|남동| | |last|
...
|fire_hydrant/type|3|combo| | | | | |wall|Wall|벽| | |last|
