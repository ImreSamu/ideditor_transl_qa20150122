...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Prieiga| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Nežinoma|last|
|access_simple|1|combo|Access|Prieiga| | |access| | | |yes|taip|last|
|access_toilets|1|combo|Access|Prieiga| | |access| | | | | |last|
|address|1|address|Address|Adresas|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Administracinis lygis| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|Tipas| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|Prieiga| | |aerialway:access|entry|Entry|Įėjimas| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|Išėjimas| | |last|
|aerialway/access|3|combo| | | | | |both|Both|Abu| | |last|
|aerialway/bubble|1|check|Bubble|Keltuvas| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|Talpa (per valandą)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|Trukmė (minutėmis)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|Šildomas| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|Keleivių kiekis| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|Prieiga (vasarai)| | |aerialway:summer:access|entry|Entry|Įėjimas| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|Išėjimas| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|Abu| | |last|
|aeroway|1|typeCombo|Type|Tipas| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|Tipas| | |amenity| | | | | |last|
|artist|1|text|Artist|Menininkas| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|Tipas| | |artwork_type| | | | | |last|
|atm|1|check|ATM|ATM| | |atm| | | | | |last|
|backrest|1|check|Backrest|Atlošas| | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|Tipas| | |barrier| | | | | |last|
...
|cardinal_direction|1|combo|Direction|Kryptis| | |direction|N|North|Šiaurė| | |last|
|cardinal_direction|2|combo| | | | | |E|East|Rytai| | |last|
|cardinal_direction|3|combo| | | | | |S|South|Pietūs| | |last|
|cardinal_direction|4|combo| | | | | |W|West|Vakarai| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|Šiaurės rytai| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|Pietryčiai| | |last|
