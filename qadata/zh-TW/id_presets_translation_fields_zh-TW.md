...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|通行限制| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|未知種類|last|
|access_simple|1|combo|Access|通行限制| | |access| | | |yes|有|last|
|access_toilets|1|combo|Access|開放與否| | |access| | | | | |last|
|address|1|address|Address|地址|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|行政級別| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|種類| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|通行方向| | |aerialway:access|entry|Entry|進入| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|離開| | |last|
|aerialway/access|3|combo| | | | | |both|Both|雙向| | |last|
|aerialway/bubble|1|check|Bubble|椅罩| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|輸送客量（每小時）| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|時間（分鐘）| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|暖氣| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|載客數| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|通行方向（夏季）| | |aerialway:summer:access|entry|Entry|進入| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|離開| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|雙向| | |last|
|aeroway|1|typeCombo|Type|種類| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|種類| | |amenity| | | | | |last|
|artist|1|text|Artist|藝術家| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|種類| | |artwork_type| | | | | |last|
|atm|1|check|ATM|自動櫃員機| | |atm| | | | | |last|
|backrest|1|check|Backrest|椅背| | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|種類| | |barrier| | | | | |last|
|bench|1|check|Bench|長凳| | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|種類| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|種類| | |boundary| | | | | |last|
|building|1|typeCombo|Building|建築物| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|建築物| | |building| | | | | |last|
...
|cardinal_direction|2|combo| | | | | |E|East|東| | |last|
|cardinal_direction|3|combo| | | | | |S|South|南| | |last|
|cardinal_direction|4|combo| | | | | |W|West|西| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|東北| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|東南| | |last|
