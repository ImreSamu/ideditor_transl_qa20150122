...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Dostęp| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Nieznane|last|
|access_simple|1|combo|Access|Dostęp| | |access| | | |yes|tak|last|
|access_toilets|1|combo|Access|Dostęp| | |access| | | | | |last|
|address|1|address|Address|Adres|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Poziom administracyjny| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|Typ| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|Dostęp| | |aerialway:access|entry|Entry|Wejście| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|Wyjście| | |last|
|aerialway/access|3|combo| | | | | |both|Both|Oba| | |last|
|aerialway/bubble|1|check|Bubble|osłona przeciwwiatrowa| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|Przepustowość (na godzinę)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|Czas trwania ( w minutach)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|Ogrzewany| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|ilość miejsc | | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|Dostępność w sezonie letnim| | |aerialway:summer:access|entry|Entry|Wejście| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|Wyjście| | |last|
...
|artist|1|text|Artist|Dzieło sztuki| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|Typ| | |artwork_type| | | | | |last|
|atm|1|check|ATM|Bankomat| | |atm| | | | | |last|
|backrest|1|check|Backrest|Oparcie| | |backrest| | | | | |last|
...
|building|1|typeCombo|Building|Budynek| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|Budynek| | |building| | | | | |last|
|capacity|1|number|Capacity|Pojemność| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|Kierunek| | |direction|N|North|Północ| | |last|
|cardinal_direction|2|combo| | | | | |E|East|Wschód| | |last|
|cardinal_direction|3|combo| | | | | |S|South|Południe| | |last|
|cardinal_direction|4|combo| | | | | |W|West|Zachód| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|Północny wschód| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|Południowy wschód| | |last|
...
|ref|1|text|Reference|Numer referencyjny| | |ref| | | | | |last|
...
|smoothness|8|combo| | | | | |impassible|Impassible / No wheeled vehicle|Nieprzejezdny dla pojazdów kołowych| | |last|
...
|width|1|number|Width (Meters)|Szerokość (w metrach)| | |width| | | | | |last|
