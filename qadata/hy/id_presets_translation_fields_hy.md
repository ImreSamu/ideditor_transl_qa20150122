...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Մատչելիություն| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown| |last|
|access_simple|1|combo|Access| | | |access| | | |yes| |last|
|access_toilets|1|combo|Access| | | |access| | | | | |last|
|address|1|address|Address|Հասցե|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
...
|atm|1|check|ATM|Բանկոմատ| | |atm| | | | | |last|
...
|building|1|typeCombo|Building|Շինություն| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|Շինություն| | |building| | | | | |last|
...
|maxspeed|1|maxspeed|Speed Limit|Արագության սահմանափակում| | |maxspeed| | | |40, 50, 60...| |last|
...
|opening_hours|1|text|Hours|Աշխատանքային ժամեր| | |opening_hours| | | | | |last|
...
|phone|1|tel|Phone|Հեռախոս|telephone|true|phone| | | |+31 42 123 4567| |last|
...
|website|1|url|Website|Կայք|website|true|website| | | |http://example.com/| |last|
