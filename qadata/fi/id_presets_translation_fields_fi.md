...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Käyttöoikeus| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Tuntematon|last|
|access_simple|1|combo|Access| | | |access| | | |yes|kyllä|last|
|access_toilets|1|combo|Access| | | |access| | | | | |last|
|address|1|address|Address|Osoite|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Hallinnointitaso| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|Tyyppi| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|Käyttöoikeus| | |aerialway:access|entry|Entry|| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|| | |last|
|aerialway/access|3|combo| | | | | |both|Both|| | |last|
|aerialway/bubble|1|check|Bubble|Tuulisuoja| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|Tuntikapasiteetti| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|Matka-aika (minuutteina)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|Lämmitys| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|Vaunun matkustajamäärä| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|Käyttöoikeus kesällä| | |aerialway:summer:access|entry|Entry|| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|| | |last|
|aeroway|1|typeCombo|Type|Tyyppi| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|Tyyppi| | |amenity| | | | | |last|
|artist|1|text|Artist|Taiteilija| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|Tyyppi| | |artwork_type| | | | | |last|
|atm|1|check|ATM|Pankkiautomaatti| | |atm| | | | | |last|
|backrest|1|check|Backrest|Selkänoja| | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|Tyyppi| | |barrier| | | | | |last|
|bench|1|check|Bench|Penkki| | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|Tyyppi| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|Tyyppi| | |boundary| | | | | |last|
|building|1|typeCombo|Building|Rakennus| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|Rakennus| | |building| | | | | |last|
|capacity|1|number|Capacity|Paikkamäärä| | |capacity| | | |50, 100, 200...|5, 10, 20, 100...|last|
|cardinal_direction|1|combo|Direction|Suunta| | |direction|N|North|Pohjoinen| | |last|
|cardinal_direction|2|combo| | | | | |E|East|Itä| | |last|
|cardinal_direction|3|combo| | | | | |S|South|Etelä| | |last|
|cardinal_direction|4|combo| | | | | |W|West|Länsi| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|Koillinen| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|Kaakko| | |last|
