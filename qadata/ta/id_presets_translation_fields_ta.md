...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access| | | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|அறியப்படவில்லை|last|
|access_simple|1|combo|Access| | | |access| | | |yes| |last|
|access_toilets|1|combo|Access| | | |access| | | | | |last|
|address|1|address|Address|முகவரி|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level| | | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|வகை| | |aerialway| | | | | |last|
...
|aerialway/capacity|1|number|Capacity (per hour)| | | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)| | | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated| | | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy| | | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
...
|aeroway|1|typeCombo|Type|வகை| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|வகை| | |amenity| | | | | |last|
|artist|1|text|Artist| | | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|வகை| | |artwork_type| | | | | |last|
|atm|1|check|ATM|ஏ.டி.எம்| | |atm| | | | | |last|
|backrest|1|check|Backrest| | | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|வகை| | |barrier| | | | | |last|
|bench|1|check|Bench| | | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|வகை| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|வகை| | |boundary| | | | | |last|
|building|1|typeCombo|Building|கட்டிடம்| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|கட்டிடம்| | |building| | | | | |last|
|capacity|1|number|Capacity|கொள்ளளவு| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|திசை| | |direction|N|North|| | |last|
...
|clock_direction|1|combo|Direction|திசை| | |direction|clockwise|Clockwise|| | |last|
...
|construction|1|combo|Type|வகை| | |construction| | | | | |last|
|country|1|combo|Country|நாடு| | |country| | | | | |last|
|covered|1|check|Covered| | | |covered| | | | | |last|
|craft|1|typeCombo|Type| | | |craft| | | | | |last|
|crop|1|combo|Crop| | | |crop| | | | | |last|
|crossing|1|combo|Type|வகை| | |crossing| | | | | |last|
...
|emergency|1|check|Emergency|அவசரநிலை| | |emergency| | | | | |last|
|entrance|1|typeCombo|Type|வகை| | |entrance| | | | | |last|
|except|1|combo|Exceptions| | | |except| | | | | |last|
|fax|1|tel|Fax|தொலைநகல்| | |fax| | | |+31 42 123 4567|+31 42 123 4567|last|
|fee|1|check|Fee| | | |fee| | | | | |last|
|fire_hydrant/type|1|combo|Type|வகை| | |fire_hydrant:type|pillar|Pillar/Aboveground|| | |last|
...
|fixme|1|textarea|Fix Me|என்னை சரிபடுத்து| | |fixme| | | | | |last|
...
|generator/source|1|combo|Source|மூலம்| | |generator:source| | | | | |last|
|generator/type|1|combo|Type|வகை| | |generator:type| | | | | |last|
|golf_hole|1|text|Reference| | | |ref| | | |Hole number (1-18)| |last|
|handicap|1|number|Handicap| | | |handicap| | | |1-18|1-18|last|
|highway|1|typeCombo|Type|வகை| | |highway| | | | | |last|
|historic|1|typeCombo|Type|வகை| | |historic| | | | | |last|
...
|information|1|typeCombo|Type|வகை| | |information| | | | | |last|
|internet_access|1|combo|Internet Access|இணைய அணுகல்| | |internet_access|yes|Yes|| | |last|
|internet_access|2|combo| | | | | |no|No|| | |last|
...
|landuse|1|typeCombo|Type|வகை| | |landuse| | | | | |last|
|lanes|1|number|Lanes|சந்துகள்| | |lanes| | | |1, 2, 3...|1, 2, 3...|last|
|layer|1|combo|Layer|அடுக்கு| | |layer| | | | | |last|
|leisure|1|typeCombo|Type|வகை| | |leisure| | | | | |last|
|length|1|number|Length (Meters)| | | |length| | | | | |last|
|levels|1|number|Levels|நிலைகள்| | |building:levels| | | |2, 4, 6...|2, 4, 6...|last|
|lit|1|check|Lit| | | |lit| | | | | |last|
|location|1|combo|Location|இடம்| | |location| | | | | |last|
|man_made|1|typeCombo|Type|வகை| | |man_made| | | | | |last|
|maxspeed|1|maxspeed|Speed Limit|வேக எல்லை| | |maxspeed| | | |40, 50, 60...|40, 50, 60...|last|
...
|name|1|localized|Name|பெயர்| | |name| | | |Common name (if any)| |last|
|natural|1|typeCombo|Natural|இயற்கையான| | |natural| | | | | |last|
|network|1|text|Network|நெட்வொர்க்| | |network| | | | | |last|
|note|1|textarea|Note|குறிப்பு|note|true|note| | | | | |last|
|office|1|typeCombo|Type|வகை| | |office| | | | | |last|
|oneway|1|check|One Way|ஒரு வழி| | |oneway| | | | | |last|
|oneway_yes|1|check|One Way|ஒரு வழி| | |oneway| | | | | |last|
|opening_hours|1|text|Hours|மணிநேரங்கள்| | |opening_hours| | | | | |last|
|operator|1|text|Operator|இயக்குபவர்| | |operator| | | | | |last|
|par|1|number|Par| | | |par| | | |3, 4, 5...|3, 4, 5...|last|
|park_ride|1|check|Park and Ride| | | |park_ride| | | | | |last|
|parking|1|combo|Type|வகை| | |parking|surface|Surface|| | |last|
...
|phone|1|tel|Phone|தொலைபேசி|telephone|true|phone| | | |+31 42 123 4567|+31 42 123 4567|last|
...
|piste/type|1|typeCombo|Type|வகை| | |piste:type| | | | | |last|
|place|1|typeCombo|Type|வகை| | |place| | | | | |last|
|population|1|text|Population| | | |population| | | | | |last|
|power|1|typeCombo|Type|வகை| | |power| | | | | |last|
|railway|1|typeCombo|Type|வகை| | |railway| | | | | |last|
...
|relation|1|combo|Type|வகை| | |type| | | | | |last|
|religion|1|combo|Religion|மதம்| | |religion| | | | | |last|
|restriction|1|combo|Type|வகை| | |restriction| | | | | |last|
|restrictions|1|restrictions|Turn Restrictions| |restrictions| | | | | | | |last|
|route|1|combo|Type|வகை| | |route| | | | | |last|
|route_master|1|combo|Type|வகை| | |route_master| | | | | |last|
...
|service|1|combo|Type|வகை| | |service| | | | | |last|
...
|shelter_type|1|combo|Type|வகை| | |shelter_type| | | | | |last|
|shop|1|typeCombo|Type|வகை| | |shop| | | | | |last|
...
|source|1|text|Source|மூலம்|source|true|source| | | | | |last|
|sport|1|combo|Sport|விளையாட்டு| | |sport| | | | | |last|
...
|studio_type|1|combo|Type|வகை| | |type| | | | | |last|
...
|tourism|1|typeCombo|Type|வகை| | |tourism| | | | | |last|
...
|tree_type|1|combo|Type|வகை| | |type| | | | | |last|
|trees|1|combo|Trees| | | |trees| | | | | |last|
|tunnel|1|combo|Tunnel| | | |tunnel| | | | | |last|
|vending|1|combo|Type of Goods| | | |vending| | | | | |last|
|water|1|combo|Type|வகை| | |water| | | | | |last|
|waterway|1|typeCombo|Type|வகை| | |waterway| | | | | |last|
|website|1|url|Website|இணையதளம்|website|true|website| | | |http://example.com/|http://example.com/|last|
|wetland|1|combo|Type|வகை| | |wetland| | | | | |last|
|wheelchair|1|radio|Wheelchair Access| |wheelchair|true|wheelchair| | | | | |last|
|width|1|number|Width (Meters)| | | |width| | | | | |last|
|wikipedia|1|wikipedia|Wikipedia|விக்கிப்பீடியா|wikipedia|true|wikipedia| | | | | |last|
|wood|1|combo|Type|வகை| | |wood| | | | | |last|
