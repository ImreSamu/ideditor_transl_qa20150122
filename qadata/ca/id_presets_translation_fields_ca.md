...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Accés| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Desconegut|last|
|access_simple|1|combo|Access|Accés| | |access| | | |yes|sí|last|
|access_toilets|1|combo|Access|Accés| | |access| | | | | |last|
|address|1|address|Address|Adreça|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Nivell administratiu| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|Tipus| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|Accés| | |aerialway:access|entry|Entry|Entrada| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|Sortida| | |last|
|aerialway/access|3|combo| | | | | |both|Both|Ambdues| | |last|
|aerialway/bubble|1|check|Bubble|Bombolla| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|Capacitat (per hora)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|Duració (minuts)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|Climatitzat| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|Ocupació| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|Accés (estival)| | |aerialway:summer:access|entry|Entry|Entrada| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|Sortida| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|Ambdues| | |last|
|aeroway|1|typeCombo|Type|Tipus| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|Tipus| | |amenity| | | | | |last|
|artist|1|text|Artist|Artista| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|Tipus| | |artwork_type| | | | | |last|
|atm|1|check|ATM|Caixer automàtic| | |atm| | | | | |last|
|backrest|1|check|Backrest|Banc públic| | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|Tipus| | |barrier| | | | | |last|
|bench|1|check|Bench|Banc per a asseure's| | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|Tipus| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|Tipus| | |boundary| | | | | |last|
|brand|1|text|Brand|Marca| | |brand| | | | | |last|
|building|1|typeCombo|Building|Edifici| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|Edifici| | |building| | | | | |last|
|capacity|1|number|Capacity|Capacitat| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|Direcció| | |direction|N|North|Nord| | |last|
|cardinal_direction|2|combo| | | | | |E|East|Est| | |last|
|cardinal_direction|3|combo| | | | | |S|South|Sud| | |last|
|cardinal_direction|4|combo| | | | | |W|West|Oest| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|Nord-est| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|Sud-est| | |last|
...
|leaf_cycle|2|combo| | | | | |deciduous|Deciduous|Caducifoli| | |last|
...
|office|1|typeCombo|Type|Tipus| | |office| | | | | |last|
...
|ref|1|text|Reference|Referència| | |ref| | | | | |last|
...
|width|1|number|Width (Meters)|Amplada (metres)| | |width| | | | | |last|
