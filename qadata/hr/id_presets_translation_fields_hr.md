...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Pristup| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Nepoznat|last|
|access_simple|1|combo|Access|Pristup| | |access| | | |yes|da|last|
|access_toilets|1|combo|Access|Pristup| | |access| | | | | |last|
|address|1|address|Address|Adresa|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Administrativno područje| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|Tip| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|Pristup| | |aerialway:access|entry|Entry|Ulaz| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|Izlaz| | |last|
...
|aerialway/heating|1|check|Heated|Grijano| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|Broj ljudi| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|Pristup (ljeto)| | |aerialway:summer:access|entry|Entry|Ulaz| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|Izlaz| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|Oba| | |last|
|aeroway|1|typeCombo|Type|Vrsta| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|Vrsta| | |amenity| | | | | |last|
|artist|1|text|Artist|Umjetnik| | |artist_name| | | | | |last|
...
|building|1|typeCombo|Building|Zgrada| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|Zgrada| | |building| | | | | |last|
|capacity|1|number|Capacity|Kapacitet| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|Smijer| | |direction|N|North|Sjever| | |last|
|cardinal_direction|2|combo| | | | | |E|East|Istok| | |last|
|cardinal_direction|3|combo| | | | | |S|South|Jug| | |last|
|cardinal_direction|4|combo| | | | | |W|West|Zapad| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|Sjeveroistok| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|Jugoistok| | |last|
