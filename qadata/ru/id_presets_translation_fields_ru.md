...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Легальный доступ| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|не указанно|last|
|access_simple|1|combo|Access|Легальный доступ| | |access| | | |yes|да для всех|last|
|access_toilets|1|combo|Access|Доступ| | |access| | | | | |last|
|address|1|address|Address|Адресная информация|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Административный уровень| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|Тип| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|Доступ| | |aerialway:access|entry|Entry|Вход| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|Выход| | |last|
|aerialway/access|3|combo| | | | | |both|Both|Оба| | |last|
|aerialway/bubble|1|check|Bubble|Пузырь| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|Пропускная способность (в час)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|Продолжительность (минут)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|Обогреваемая| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|Вместимость| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|Доступ (летом)| | |aerialway:summer:access|entry|Entry|Вход| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|Выход| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|Оба| | |last|
|aeroway|1|typeCombo|Type|Тип| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|Тип| | |amenity| | | | | |last|
|artist|1|text|Artist|Художник| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|Тип произведения искусства| | |artwork_type| | | | | |last|
|atm|1|check|ATM|Банкомат| | |atm| | | | | |last|
|backrest|1|check|Backrest|Спинка| | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|Тип преграды| | |barrier| | | | | |last|
|bench|1|check|Bench|Скамейка| | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|Тип велосипедной парковки| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|Тип границы| | |boundary| | | | | |last|
|brand|1|text|Brand| | | |brand| | | | | |last|
|building|1|typeCombo|Building|Здание| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|Здание| | |building| | | | | |last|
|capacity|1|number|Capacity|Вместимость| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|Направление| | |direction|N|North|Север| | |last|
|cardinal_direction|2|combo| | | | | |E|East|Восток| | |last|
|cardinal_direction|3|combo| | | | | |S|South|Юг| | |last|
|cardinal_direction|4|combo| | | | | |W|West|Запад| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|Северо-восток| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|Юго-восток| | |last|
