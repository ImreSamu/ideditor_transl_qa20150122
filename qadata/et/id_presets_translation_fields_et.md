...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Juurdepääs| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Teadmata|last|
|access_simple|1|combo|Access|Juurdepääs| | |access| | | |yes|jah|last|
|access_toilets|1|combo|Access|Juurdepääs| | |access| | | | | |last|
|address|1|address|Address|Aadress|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level| | | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type| | | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access| | | |aerialway:access|both|Entry|Mõlemad| | |last|
...
|aeroway|1|typeCombo|Type|Tüüp| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|Tüüp| | |amenity| | | | | |last|
|artist|1|text|Artist| | | |artist_name| | | | | |last|
|artwork_type|1|combo|Type| | | |artwork_type| | | | | |last|
|atm|1|check|ATM|Pangaautomaat| | |atm| | | | | |last|
|backrest|1|check|Backrest| | | |backrest| | | | | |last|
|barrier|1|typeCombo|Type| | | |barrier| | | | | |last|
|bench|1|check|Bench| | | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|Tüüp| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type| | | |boundary| | | | | |last|
|brand|1|text|Brand| | | |brand| | | | | |last|
|building|1|typeCombo|Building|Hoone| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|Hoone| | |building| | | | | |last|
|capacity|1|number|Capacity|Mahtutavus| | |capacity| | | |50, 100, 200...| |last|
|cardinal_direction|1|combo|Direction|Suund| | |direction|N|North|| | |last|
