...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Přístup| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Není známo|last|
|access_simple|1|combo|Access|Přístup| | |access| | | |yes|ano|last|
|access_toilets|1|combo|Access|Přístup| | |access| | | | | |last|
|address|1|address|Address|Adresa|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Administrativní úroveň| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|Typ| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|Přístup| | |aerialway:access|entry|Entry|Vstup| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|Výstup| | |last|
|aerialway/access|3|combo| | | | | |both|Both|Oboje| | |last|
|aerialway/bubble|1|check|Bubble|Stříška| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|Odbaví lidí (za hodinu)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|Délka cesty (v minutách)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|Vytápěno| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|Kapacita (počet cestujících)| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|Přístup v létě| | |aerialway:summer:access|entry|Entry|Vstup| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|Výstup| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|Oboje| | |last|
|aeroway|1|typeCombo|Type|Typ| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|Typ| | |amenity| | | | | |last|
|artist|1|text|Artist|Umělec| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|Typ| | |artwork_type| | | | | |last|
|atm|1|check|ATM|Bankomat| | |atm| | | | | |last|
|backrest|1|check|Backrest|Opěradlo| | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|Typ| | |barrier| | | | | |last|
|bench|1|check|Bench|Lavička| | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|Typ| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|Typ| | |boundary| | | | | |last|
|brand|1|text|Brand|Obchodní značka| | |brand| | | | | |last|
|building|1|typeCombo|Building|Budova| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|Budova| | |building| | | | | |last|
|capacity|1|number|Capacity|Kapacita| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|Směr| | |direction|N|North|Sever| | |last|
|cardinal_direction|2|combo| | | | | |E|East|Východ| | |last|
|cardinal_direction|3|combo| | | | | |S|South|Jih| | |last|
|cardinal_direction|4|combo| | | | | |W|West|Západ| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|Severovýchod| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|Jihovýchod| | |last|
...
|fire_hydrant/type|3|combo| | | | | |wall|Wall|Nástěnný| | |last|
...
|leaf_cycle|2|combo| | | | | |deciduous|Deciduous|Opadavé| | |last|
...
|ref|1|text|Reference|Označení| | |ref| | | | | |last|
...
|width|1|number|Width (Meters)|Šířka (v metrech)| | |width| | | | | |last|
