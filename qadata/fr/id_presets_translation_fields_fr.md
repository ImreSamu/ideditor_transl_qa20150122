...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Accès| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Inconnu|last|
|access_simple|1|combo|Access|Accès| | |access| | | |yes|oui|last|
|access_toilets|1|combo|Access|Accès| | |access| | | | | |last|
|address|1|address|Address|Adresse|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Niveau administratif| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|Type| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|Accès| | |aerialway:access|entry|Entry|Entrée| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|Sortie| | |last|
|aerialway/access|3|combo| | | | | |both|Both|Les deux| | |last|
|aerialway/bubble|1|check|Bubble|Bulle| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|Capacité (par heure)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|Durée (minutes)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|Chauffé| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|Nombre de places| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|Accès (été)| | |aerialway:summer:access|entry|Entry|Entrée| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|Sortie| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|Les deux| | |last|
|aeroway|1|typeCombo|Type|Type| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|Type| | |amenity| | | | | |last|
|artist|1|text|Artist|Artiste| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|Type| | |artwork_type| | | | | |last|
|atm|1|check|ATM|Distributeur de billets| | |atm| | | | | |last|
|backrest|1|check|Backrest|Dossier| | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|Type| | |barrier| | | | | |last|
|bench|1|check|Bench|Banc| | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|Type| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|Type| | |boundary| | | | | |last|
|brand|1|text|Brand|Marque| | |brand| | | | | |last|
|building|1|typeCombo|Building|Bâtiment | | |building| | | | | |last|
|building_area|1|defaultcheck|Building|Bâtiment| | |building| | | | | |last|
|capacity|1|number|Capacity|Capacité| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|Sens| | |direction|N|North|Nord| | |last|
|cardinal_direction|2|combo| | | | | |E|East|Est| | |last|
|cardinal_direction|3|combo| | | | | |S|South|Sud| | |last|
|cardinal_direction|4|combo| | | | | |W|West|Ouest| | |last|
...
|leaf_cycle|2|combo| | | | | |deciduous|Deciduous|Caduc| | |last|
