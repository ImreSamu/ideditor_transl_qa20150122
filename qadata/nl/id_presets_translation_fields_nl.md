...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Toegang| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Onbekend|last|
|access_simple|1|combo|Access|Toegang| | |access| | | |yes|ja|last|
|access_toilets|1|combo|Access|Toegang| | |access| | | | | |last|
|address|1|address|Address|Adres|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Bestuurlijk niveau| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|Type| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|Toegang| | |aerialway:access|entry|Entry|Ingang| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|Uitgang| | |last|
|aerialway/access|3|combo| | | | | |both|Both|Beide| | |last|
|aerialway/bubble|1|check|Bubble|Bubbel| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|Capaciteit (per uur)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000, ...|last|
|aerialway/duration|1|number|Duration (minutes)|Duur (minuten)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3, ...|last|
|aerialway/heating|1|check|Heated|Verwarmd| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|Bezetting| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8, ...|last|
|aerialway/summer/access|1|combo|Access (summer)|Toegang (zomer)| | |aerialway:summer:access|entry|Entry|Ingang| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|Uitgang| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|Beide| | |last|
|aeroway|1|typeCombo|Type|Type| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|Type| | |amenity| | | | | |last|
|artist|1|text|Artist|Kunstenaar| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|Type| | |artwork_type| | | | | |last|
|atm|1|check|ATM|Pinautomaat| | |atm| | | | | |last|
|backrest|1|check|Backrest|Rugleuning| | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|Type| | |barrier| | | | | |last|
|bench|1|check|Bench|Bank| | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|Type| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|Type| | |boundary| | | | | |last|
|brand|1|text|Brand|Merk| | |brand| | | | | |last|
|building|1|typeCombo|Building|Gebouw| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|Gebouw| | |building| | | | | |last|
|capacity|1|number|Capacity|Inhoud| | |capacity| | | |50, 100, 200...|50, 100, 200, ...|last|
|cardinal_direction|1|combo|Direction|Richting| | |direction|N|North|Noord| | |last|
|cardinal_direction|2|combo| | | | | |E|East|Oost| | |last|
|cardinal_direction|3|combo| | | | | |S|South|Zuid| | |last|
|cardinal_direction|4|combo| | | | | |W|West|West| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|Noordoost| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|Zuidoost| | |last|
...
|fire_hydrant/type|3|combo| | | | | |wall|Wall|Muur| | |last|
...
|leaf_cycle|2|combo| | | | | |deciduous|Deciduous|Bladverliezend| | |last|
...
|piste/difficulty|2|combo| | | | | |easy|Easy (green circle)|makkelijk (groene rondje)| | |last|
|piste/difficulty|3|combo| | | | | |intermediate|Intermediate (blue square)|Gemiddeld (blauw vierkant)| | |last|
|piste/difficulty|4|combo| | | | | |advanced|Advanced (black diamond)|Gevorderd (zwarte diamand)| | |last|
|piste/difficulty|5|combo| | | | | |expert|Expert (double black diamond)|Expert (dubbele zwarte diamand)| | |last|
|piste/difficulty|6|combo| | | | | |extreme|Freeride (off-piste)|Extreem (klimuitrusting vereist)| | |last|
|piste/difficulty|7|combo| | | | | |extreme|Extreme (climbing equipment required)|| | |last|
|piste/grooming|1|combo|Grooming| | | |piste:grooming|classic|Classic|Klassiek| | |last|
|piste/grooming|2|combo| | | | | |mogul|Mogul|Mogul| | |last|
|piste/grooming|3|combo| | | | | |backcountry|Backcountry|Binnenland| | |last|
|piste/grooming|4|combo| | | | | |classic+skating|Classic and Skating|Klassiek en Rolschaatsen| | |last|
|piste/grooming|5|combo| | | | | |scooter|Scooter/Snowmobile|Scooter/Sneeuwscooter| | |last|
|piste/grooming|6|combo| | | | | |skating|Skating|Rolschaatsen| | |last|
...
|ref|1|text|Reference|Nummering| | |ref| | | | | |last|
...
|smoothness|8|combo| | | | | |impassible|Impassible / No wheeled vehicle|Ondoordringbaar / Geen voertuig op wielen| | |last|
...
|width|1|number|Width (Meters)|Breedte (Meter)| | |width| | | | | |last|
