...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access| | | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Nekonata|last|
|access_simple|1|combo|Access| | | |access| | | |yes|jes|last|
|access_toilets|1|combo|Access| | | |access| | | | | |last|
|address|1|address|Address|Adreso|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
...
|aeroway|1|typeCombo|Type| | | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type| | | |amenity| | | | | |last|
|artist|1|text|Artist|Artisto| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type| | | |artwork_type| | | | | |last|
|atm|1|check|ATM| | | |atm| | | | | |last|
|backrest|1|check|Backrest| | | |backrest| | | | | |last|
|barrier|1|typeCombo|Type| | | |barrier| | | | | |last|
|bench|1|check|Bench| | | |bench| | | | | |last|
|bicycle_parking|1|combo|Type| | | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type| | | |boundary| | | | | |last|
|brand|1|text|Brand| | | |brand| | | | | |last|
|building|1|typeCombo|Building| | | |building| | | | | |last|
|building_area|1|defaultcheck|Building| | | |building| | | | | |last|
|capacity|1|number|Capacity| | | |capacity| | | |50, 100, 200...| |last|
...
|construction|1|combo|Type| | | |construction| | | | | |last|
|country|1|combo|Country|Lando| | |country| | | | | |last|
|covered|1|check|Covered| | | |covered| | | | | |last|
|craft|1|typeCombo|Type| | | |craft| | | | | |last|
|crop|1|combo|Crop| | | |crop| | | | | |last|
|crossing|1|combo|Type| | | |crossing| | | | | |last|
...
|electrified|1|combo|Electrification| | | |electrified|no|Contact Line|Ne|Contact Line, Electrified Rail...| |last|
...
|fax|1|tel|Fax| | | |fax| | | |+31 42 123 4567|+31 42 123 4567|last|
...
|gender|1|radio|Gender| | | |male,female,unisex| | | |Unknown|Nekonata|last|
...
|golf_hole|1|text|Reference|Referenco| | |ref| | | |Hole number (1-18)| |last|
...
|internet_access|1|combo|Internet Access| | | |internet_access|yes|Yes|Jes| | |last|
...
|levels|1|number|Levels| | | |building:levels| | | |2, 4, 6...|2, 4, 6...|last|
|lit|1|check|Lit| | | |lit| | | | | |last|
|location|1|combo|Location| | | |location| | | | | |last|
|man_made|1|typeCombo|Type| | | |man_made| | | | | |last|
|maxspeed|1|maxspeed|Speed Limit| | | |maxspeed| | | |40, 50, 60...|40, 50, 60...|last|
...
|mtb/scale/imba|1|combo|IMBA Trail Difficulty| | | |mtb:scale:imba|1|Easiest (white circle)|Facila (verda rondo)|Easy, Medium, Difficult...| |last|
...
|name|1|localized|Name|Nomo| | |name| | | |Common name (if any)| |last|
|natural|1|typeCombo|Natural| | | |natural| | | | | |last|
|network|1|text|Network| | | |network| | | | | |last|
|note|1|textarea|Note|Noto|note|true|note| | | | | |last|
|office|1|typeCombo|Type| | | |office| | | | | |last|
|oneway|1|check|One Way| | | |oneway| | | | | |last|
|oneway_yes|1|check|One Way| | | |oneway| | | | | |last|
|opening_hours|1|text|Hours|Horoj| | |opening_hours| | | | | |last|
...
|phone|1|tel|Phone|Telefono|telephone|true|phone| | | |+31 42 123 4567|+31 42 1231 4567|last|
...
|ref|1|text|Reference|Referenco| | |ref| | | | | |last|
|relation|1|combo|Type| | | |type| | | | | |last|
|religion|1|combo|Religion|Religio| | |religion| | | | | |last|
...
|source|1|text|Source|Fonto|source|true|source| | | | | |last|
