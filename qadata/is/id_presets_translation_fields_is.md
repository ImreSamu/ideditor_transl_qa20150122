...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Aðgangur| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Óþekkt|last|
|access_simple|1|combo|Access| | | |access| | | |yes| |last|
|access_toilets|1|combo|Access| | | |access| | | | | |last|
|address|1|address|Address|Heimilisfang|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Stjórnsýslustig| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type| | | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access| | | |aerialway:access|exit|Entry|Útgangur| | |last|
|aerialway/access|2|combo| | | | | |both|Exit|Bæði| | |last|
...
|aeroway|1|typeCombo|Type|Tegund| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|Tegund| | |amenity| | | | | |last|
|artist|1|text|Artist| | | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|Tegund| | |artwork_type| | | | | |last|
|atm|1|check|ATM|Hraðbanki| | |atm| | | | | |last|
|backrest|1|check|Backrest| | | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|Tegund| | |barrier| | | | | |last|
|bench|1|check|Bench| | | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|Tegund| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|Tegund| | |boundary| | | | | |last|
|brand|1|text|Brand| | | |brand| | | | | |last|
|building|1|typeCombo|Building|Bygging| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|Bygging| | |building| | | | | |last|
|capacity|1|number|Capacity|Áhorfendafjöldi/Rýmd| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|Átt| | |direction|NW|North|Norðvestur| | |last|
