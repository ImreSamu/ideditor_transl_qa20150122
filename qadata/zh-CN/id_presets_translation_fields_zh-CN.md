...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|通行限制| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|未知|last|
|access_simple|1|combo|Access|通行限制| | |access| | | |yes|是|last|
|access_toilets|1|combo|Access|连接| | |access| | | | | |last|
|address|1|address|Address|地址|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|行政级别| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|类型| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|通行限制| | |aerialway:access|entry|Entry|入口| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|出口| | |last|
|aerialway/access|3|combo| | | | | |both|Both|双向| | |last|
|aerialway/bubble|1|check|Bubble|圆形顶| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|容量(每小时)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|持续时间(分钟)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|暖气| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|载客数| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|通行方向（夏季）| | |aerialway:summer:access|entry|Entry|入口| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|出口| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|双方| | |last|
|aeroway|1|typeCombo|Type|类型| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|类型| | |amenity| | | | | |last|
|artist|1|text|Artist|艺人| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|类型| | |artwork_type| | | | | |last|
|atm|1|check|ATM|自动提款机（ATM）| | |atm| | | | | |last|
|backrest|1|check|Backrest|长椅| | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|类型| | |barrier| | | | | |last|
|bench|1|check|Bench|长凳| | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|类型| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|类型| | |boundary| | | | | |last|
...
|cardinal_direction|1|combo|Direction|方向| | |direction|N|North|北| | |last|
|cardinal_direction|2|combo| | | | | |E|East|东| | |last|
|cardinal_direction|3|combo| | | | | |S|South|南| | |last|
|cardinal_direction|4|combo| | | | | |W|West|西| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|东北| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|东南| | |last|
