...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Adgang| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Ukendt|last|
|access_simple|1|combo|Access|Adgang| | |access| | | |yes|ja|last|
|access_toilets|1|combo|Access|Adgang| | |access| | | | | |last|
|address|1|address|Address|Adresse|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Administrativt niveau| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|Type| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|Adgang| | |aerialway:access|entry|Entry|Indgang| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|Udgang| | |last|
|aerialway/access|3|combo| | | | | |both|Both|Begge| | |last|
|aerialway/bubble|1|check|Bubble|Skikabine| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|Kapacitet (per time)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|Varighed (minutter)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|Opvarmet| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|Belægning| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|Adgang (sommer)| | |aerialway:summer:access|entry|Entry|Indgang| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|Udgang| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|Begge| | |last|
|aeroway|1|typeCombo|Type|Type| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|Type| | |amenity| | | | | |last|
|artist|1|text|Artist|Kunster| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|Type| | |artwork_type| | | | | |last|
|atm|1|check|ATM|Pengeautomat| | |atm| | | | | |last|
|backrest|1|check|Backrest|Ryglæn| | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|Type| | |barrier| | | | | |last|
|bench|1|check|Bench|Bænk| | |bench| | | | | |last|
...
|building|1|typeCombo|Building|Bygning| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|Bygning| | |building| | | | | |last|
|capacity|1|number|Capacity|Kapacitet| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|Retning| | |direction|N|North|Nord| | |last|
|cardinal_direction|2|combo| | | | | |E|East|Øst| | |last|
|cardinal_direction|3|combo| | | | | |S|South|Syd| | |last|
|cardinal_direction|4|combo| | | | | |W|West|Vest| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|Nordøst| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|Sydøst| | |last|
...
|leaf_cycle|2|combo| | | | | |deciduous|Deciduous|Løvfældende| | |last|
