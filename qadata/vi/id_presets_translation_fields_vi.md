...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Quyền Truy cập| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Không rõ|last|
|access_simple|1|combo|Access|Quyền Truy cập| | |access| | | |yes|có|last|
|access_toilets|1|combo|Access|Quyền Truy cập| | |access| | | | | |last|
|address|1|address|Address|Địa chỉ|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Cấp Hành chính| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|Kiểu| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|Quyền Truy cập| | |aerialway:access|entry|Entry|Vào| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|Ra| | |last|
|aerialway/access|3|combo| | | | | |both|Both|Ra vào| | |last|
|aerialway/bubble|1|check|Bubble|Mái vòm| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|Số khách (Mỗi giờ)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000…|last|
|aerialway/duration|1|number|Duration (minutes)|Mất Thời gian (Phút)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3…|last|
|aerialway/heating|1|check|Heated|Máy sưởi| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|Số khách| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8…|last|
|aerialway/summer/access|1|combo|Access (summer)|Quyền Truy cập (Mùa hè)| | |aerialway:summer:access|entry|Entry|Vào| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|Ra| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|Ra vào| | |last|
|aeroway|1|typeCombo|Type|Loại| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|Loại| | |amenity| | | | | |last|
|artist|1|text|Artist|Nghệ sĩ| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|Kiểu| | |artwork_type| | | | | |last|
|atm|1|check|ATM|Máy Rút tiền| | |atm| | | | | |last|
|backrest|1|check|Backrest|Dựa Lưng| | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|Kiểu| | |barrier| | | | | |last|
...
|cardinal_direction|1|combo|Direction|Chiều| | |direction|N|North|Bắc| | |last|
|cardinal_direction|2|combo| | | | | |E|East|Đông| | |last|
|cardinal_direction|3|combo| | | | | |S|South|Nam| | |last|
|cardinal_direction|4|combo| | | | | |W|West|Tây| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|Đông Bắc| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|Đông Nam| | |last|
...
|fire_hydrant/type|3|combo| | | | | |wall|Wall|Tường| | |last|
...
|office|1|typeCombo|Type|Kiểu| | |office| | | | | |last|
...
|ref|1|text|Reference|Số| | |ref| | | | | |last|
...
|smoothness|8|combo| | | | | |impassible|Impassible / No wheeled vehicle|Không thể qua được bằng bánh xe| | |last|
...
|sport|1|combo|Sport|Môn Thể thao| | |sport| | | | | |last|
