...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Acesso| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Desconhecido|last|
|access_simple|1|combo|Access|Acesso| | |access| | | |yes|sim|last|
|access_toilets|1|combo|Access|Acesso| | |access| | | | | |last|
|address|1|address|Address|Endereço|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Nível Administrativo| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|Tipo| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|Acesso| | |aerialway:access|entry|Entry|Entrada| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|Saída| | |last|
|aerialway/access|3|combo| | | | | |both|Both|Ambos| | |last|
|aerialway/bubble|1|check|Bubble|Bolha| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|Capacidade (por hora)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|Duração (minutos)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|Aquecido| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|Ocupação| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|Acesso (verão)| | |aerialway:summer:access|entry|Entry|Entrada| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|Saída| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|Ambos| | |last|
...
|atm|1|check|ATM|Caixa Eletrônico| | |atm| | | | | |last|
|backrest|1|check|Backrest|Encosto| | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|Tipo| | |barrier| | | | | |last|
|bench|1|check|Bench|Assento| | |bench| | | | | |last|
...
|cardinal_direction|1|combo|Direction|Direção| | |direction|N|North|Norte| | |last|
|cardinal_direction|2|combo| | | | | |E|East|Leste| | |last|
|cardinal_direction|3|combo| | | | | |S|South|Sul| | |last|
|cardinal_direction|4|combo| | | | | |W|West|Oeste| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|Nordeste| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|Sudeste| | |last|
...
|fire_hydrant/type|3|combo| | | | | |wall|Wall|Muro| | |last|
...
|ref|1|text|Reference|Código de referência| | |ref| | | | | |last|
...
|smoothness|8|combo| | | | | |impassible|Impassible / No wheeled vehicle|Indiferente / Não para veículos sobre rodas| | |last|
...
|sport|1|combo|Sport|Esporte| | |sport| | | | | |last|
