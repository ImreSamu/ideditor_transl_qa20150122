...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|通| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|未知|last|
|access_simple|1|combo|Access|通| | |access| | | |yes| |last|
|access_toilets|1|combo|Access| | | |access| | | | | |last|
|address|1|address|Address|地埗|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|行政層次| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|類| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|通| | |aerialway:access|entry|Entry|| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|| | |last|
|aerialway/access|3|combo| | | | | |both|Both|| | |last|
|aerialway/bubble|1|check|Bubble|泡| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|載量（一小時計）| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|行程（分鐘）| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|有暖氣| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|一車人數| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|通（夏天）| | |aerialway:summer:access|entry|Entry|| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|| | |last|
|aeroway|1|typeCombo|Type|類| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|類| | |amenity| | | | | |last|
|artist|1|text|Artist|藝人| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|類| | |artwork_type| | | | | |last|
|atm|1|check|ATM|提款機| | |atm| | | | | |last|
|backrest|1|check|Backrest|長椅| | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|類| | |barrier| | | | | |last|
|bench|1|check|Bench| | | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|類| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|類| | |boundary| | | | | |last|
|brand|1|text|Brand| | | |brand| | | | | |last|
|building|1|typeCombo|Building|屋宇| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|屋宇| | |building| | | | | |last|
|capacity|1|number|Capacity|容納| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
