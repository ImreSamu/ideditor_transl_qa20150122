...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|ಪ್ರವೇಶ| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|ತಿಳಿಯದ|last|
|access_simple|1|combo|Access|ಪ್ರವೇಶ| | |access| | | |yes|ಹೌದು|last|
|access_toilets|1|combo|Access|ಪ್ರವೇಶ| | |access| | | | | |last|
|address|1|address|Address|ವಿಳಾಸ|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|ನಿರ್ವಾಹಕ ಮಟ್ಟ| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|ವಿಧ| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|ಪ್ರವೇಶ| | |aerialway:access|entry|Entry|ಒಳಗೆ| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|ಹೊರಗೆ| | |last|
|aerialway/access|3|combo| | | | | |both|Both|ಎರಡೂ| | |last|
|aerialway/bubble|1|check|Bubble|ಗುಳ್ಳೆ| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|ಸಾಮರ್ಥ್ಯ (ಗಂಟೆಗೆ)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|ಅವಧಿ (ನಿಮಿಷಗಳು)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|ಬಿಸಿ| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|ನೆಲೆಸುವಿಕೆ| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|ಪ್ರವೇಶ(ಬೇಸಿಗೆ)| | |aerialway:summer:access|entry|Entry|ಒಳಗೆ| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|ಹೊರಗೆ| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|ಎರಡೂ| | |last|
|aeroway|1|typeCombo|Type|ವಿಧ| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|ವಿಧ| | |amenity| | | | | |last|
|artist|1|text|Artist|ಕಲಾವಿದ| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|ವಿಧ| | |artwork_type| | | | | |last|
|atm|1|check|ATM|ATM| | |atm| | | | | |last|
|backrest|1|check|Backrest|ಬೆನ್ನಾಸರೆ| | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|ವಿಧ| | |barrier| | | | | |last|
|bench|1|check|Bench|ಬೆಂಚು| | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|ವಿಧ| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|ವಿಧ| | |boundary| | | | | |last|
|building|1|typeCombo|Building|ಕಟ್ಟಡ| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|ಕಟ್ಟಡ| | |building| | | | | |last|
|capacity|1|number|Capacity|ಸಾಮರ್ಥ್ಯ| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|ದಿಕ್ಕು| | |direction|N|North|ಉತ್ತರ| | |last|
|cardinal_direction|2|combo| | | | | |E|East|ಪೂರ್ವ| | |last|
|cardinal_direction|3|combo| | | | | |S|South|ದಕ್ಷಿಣ| | |last|
|cardinal_direction|4|combo| | | | | |W|West|ಪಶ್ಚಿಮ| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|ಈಶಾನ್ಯ| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|ಆಗ್ನೇಯ| | |last|
...
|office|1|typeCombo|Type|ವಿಧ| | |office| | | | | |last|
...
|ref|1|text|Reference|ಉಲ್ಲೇಖ| | |ref| | | | | |last|
...
|sport|1|combo|Sport|ಕ್ರೀಡೆ| | |sport| | | | | |last|
