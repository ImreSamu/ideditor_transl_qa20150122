...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Tillgång| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Okänt|last|
|access_simple|1|combo|Access|Tillgång| | |access| | | |yes|ja|last|
|access_toilets|1|combo|Access|Tillgång| | |access| | | | | |last|
|address|1|address|Address|Adress|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Administrativ nivå| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|Typ| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|Tillgång| | |aerialway:access|entry|Entry|Ingång| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|Utgång| | |last|
|aerialway/access|3|combo| | | | | |both|Both|Båda| | |last|
|aerialway/bubble|1|check|Bubble|Skidkabin| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|Kapacitet (per timme)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|Varaktighet (min)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|Uppvärmd| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|Antal personer| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|Tillgång (sommar)| | |aerialway:summer:access|entry|Entry|Ingång| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|Utgång| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|Båda| | |last|
|aeroway|1|typeCombo|Type|Typ| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|Typ| | |amenity| | | | | |last|
|artist|1|text|Artist|Konstnär| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|Typ| | |artwork_type| | | | | |last|
|atm|1|check|ATM|Uttagsautomat| | |atm| | | | | |last|
|backrest|1|check|Backrest|Ryggstöd| | |backrest| | | | | |last|
...
|cardinal_direction|1|combo|Direction|Riktning| | |direction|N|North|Norr| | |last|
|cardinal_direction|2|combo| | | | | |E|East|Öster| | |last|
|cardinal_direction|3|combo| | | | | |S|South|Söder| | |last|
|cardinal_direction|4|combo| | | | | |W|West|Väster| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|Nordost| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|Sydost| | |last|
...
|fire_hydrant/type|3|combo| | | | | |wall|Wall|Vägg| | |last|
...
|ref|1|text|Reference|Referens| | |ref| | | | | |last|
...
|width|1|number|Width (Meters)|Bredd (meter)| | |width| | | | | |last|
