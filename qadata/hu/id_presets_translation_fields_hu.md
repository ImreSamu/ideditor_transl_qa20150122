...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Behajtás| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Ismeretlen|last|
|access_simple|1|combo|Access|Behajtás| | |access| | | |yes|igen|last|
|access_toilets|1|combo|Access|Hozzáférés| | |access| | | | | |last|
|address|1|address|Address|Cím|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Adminisztratív szint| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|Típus| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|Be- és kiszállás| | |aerialway:access|entry|Entry|Bejárat| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|Kijárat| | |last|
|aerialway/access|3|combo| | | | | |both|Both|Mindkettő| | |last|
|aerialway/bubble|1|check|Bubble|Védőburok| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|Kapacitás (óránként)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|Menetidő (perc)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|Fűtött| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|Férőhely| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|Be- és kiszállás (nyáron)| | |aerialway:summer:access|entry|Entry|Bejárat| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|Kijárat| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|Mindkettő| | |last|
|aeroway|1|typeCombo|Type|típus| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|típus| | |amenity| | | | | |last|
|artist|1|text|Artist|Művész| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|Típus| | |artwork_type| | | | | |last|
|atm|1|check|ATM|Bankautomata| | |atm| | | | | |last|
|backrest|1|check|Backrest|Háttámla| | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|Típus| | |barrier| | | | | |last|
...
|cardinal_direction|1|combo|Direction|Irány| | |direction|N|North|Észak| | |last|
|cardinal_direction|2|combo| | | | | |E|East|Kelet| | |last|
|cardinal_direction|3|combo| | | | | |S|South|Dél| | |last|
|cardinal_direction|4|combo| | | | | |W|West|Nyugat| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|Északkelet| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|Délkelet| | |last|
