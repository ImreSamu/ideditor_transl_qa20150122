...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Ulaşım| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Bilinmeyen|last|
|access_simple|1|combo|Access|Giriş| | |access| | | |yes|evet|last|
|access_toilets|1|combo|Access|Giriş| | |access| | | | | |last|
|address|1|address|Address|Adres|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Yönetim Düzeyi| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|Tür| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|Erişim| | |aerialway:access|entry|Entry|Giriş| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|Çıkış| | |last|
|aerialway/access|3|combo| | | | | |both|Both|İkisi| | |last|
|aerialway/bubble|1|check|Bubble|Yumru| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|Kapasite (saatlik)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|süre (dakika)| | |aerialway:duration| | | |1, 2, 3...|1,2,3...|last|
|aerialway/heating|1|check|Heated|Isıtmalı| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|Doluluk| | |aerialway:occupancy| | | |2, 4, 8...|2,4,8...|last|
|aerialway/summer/access|1|combo|Access (summer)|Erişim (yaz)| | |aerialway:summer:access|entry|Entry|Giriş| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|Çıkış| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|İkisi| | |last|
|aeroway|1|typeCombo|Type|Tip| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|Tip| | |amenity| | | | | |last|
|artist|1|text|Artist| | | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|Tip| | |artwork_type| | | | | |last|
|atm|1|check|ATM|ATM| | |atm| | | | | |last|
|backrest|1|check|Backrest| | | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|Tip| | |barrier| | | | | |last|
|bench|1|check|Bench| | | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|Tip| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|Tip| | |boundary| | | | | |last|
|brand|1|text|Brand| | | |brand| | | | | |last|
|building|1|typeCombo|Building|Bina| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|Bina| | |building| | | | | |last|
|capacity|1|number|Capacity|Kapasite| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|Yön| | |direction|N|North|| | |last|
