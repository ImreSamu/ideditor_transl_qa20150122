...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Dostop| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Neznano|last|
|access_simple|1|combo|Access|Dostop| | |access| | | |yes|da|last|
|access_toilets|1|combo|Access|Dostop| | |access| | | | | |last|
|address|1|address|Address|Naslov|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Raven upravne razdelitve| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|Vrsta| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|Dostop| | |aerialway:access|entry|Entry|Vhod| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|Izhod| | |last|
|aerialway/access|3|combo| | | | | |both|Both|Oboje| | |last|
|aerialway/bubble|1|check|Bubble|Pokrov za veter| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|Zmogljivost (oseb na uro)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|Čas vožnje (minut)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|Ogrevanje| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|Število oseb| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|Dostop (poleti)| | |aerialway:summer:access|entry|Entry|Vhod| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|Izhod| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|Oboje| | |last|
|aeroway|1|typeCombo|Type|Vrsta| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|Vrsta| | |amenity| | | | | |last|
|artist|1|text|Artist|Umetnik| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|Vrsta| | |artwork_type| | | | | |last|
|atm|1|check|ATM|Bankomat| | |atm| | | | | |last|
|backrest|1|check|Backrest|Naslonjalo| | |backrest| | | | | |last|
...
|building|1|typeCombo|Building|Zgradba| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|Zgradba| | |building| | | | | |last|
|capacity|1|number|Capacity|Kapaciteta| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|Smer| | |direction|N|North|Sever| | |last|
|cardinal_direction|2|combo| | | | | |E|East|Vzhod| | |last|
|cardinal_direction|3|combo| | | | | |S|South|Jug| | |last|
|cardinal_direction|4|combo| | | | | |W|West|Zahod| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|Severovzhod| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|Jugovzhod| | |last|
