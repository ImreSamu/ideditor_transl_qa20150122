...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Достъп| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Неизвестен|last|
|access_simple|1|combo|Access| | | |access| | | |yes| |last|
|access_toilets|1|combo|Access| | | |access| | | | | |last|
|address|1|address|Address|Адрес|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Административно деление| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type| | | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access| | | |aerialway:access|entry|Entry|| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|| | |last|
|aerialway/access|3|combo| | | | | |both|Both|| | |last|
|aerialway/bubble|1|check|Bubble| | | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)| | | |aerialway:capacity| | | |500, 2500, 5000...| |last|
|aerialway/duration|1|number|Duration (minutes)| | | |aerialway:duration| | | |1, 2, 3...| |last|
|aerialway/heating|1|check|Heated| | | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy| | | |aerialway:occupancy| | | |2, 4, 8...| |last|
|aerialway/summer/access|1|combo|Access (summer)| | | |aerialway:summer:access|entry|Entry|| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|| | |last|
|aeroway|1|typeCombo|Type|Вид| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|Вид| | |amenity| | | | | |last|
|artist|1|text|Artist| | | |artist_name| | | | | |last|
|artwork_type|1|combo|Type| | | |artwork_type| | | | | |last|
|atm|1|check|ATM|Банкомат| | |atm| | | | | |last|
|backrest|1|check|Backrest| | | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|Вид| | |barrier| | | | | |last|
|bench|1|check|Bench| | | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|Вид| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|Вид| | |boundary| | | | | |last|
|building|1|typeCombo|Building|Сграда| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|Сграда| | |building| | | | | |last|
|capacity|1|number|Capacity|Капацитет| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|Посока| | |direction|N|North|| | |last|
|cardinal_direction|2|combo| | | | | |E|East|| | |last|
|cardinal_direction|3|combo| | | | | |S|South|| | |last|
|cardinal_direction|4|combo| | | | | |W|West|| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|| | |last|
...
|clock_direction|1|combo|Direction|Посока| | |direction|clockwise|Clockwise|По часовниковата стрелка| | |last|
|clock_direction|2|combo| | | | | |anticlockwise|Counterclockwise|Обратно на часовниковата стрелка| | |last|
|collection_times|1|text|Collection Times|График на събиране| | |collection_times| | | | | |last|
|construction|1|combo|Type|Вид| | |construction| | | | | |last|
|country|1|combo|Country|Държава| | |country| | | | | |last|
|covered|1|check|Covered| | | |covered| | | | | |last|
|craft|1|typeCombo|Type| | | |craft| | | | | |last|
|crop|1|combo|Crop| | | |crop| | | | | |last|
|crossing|1|combo|Type|Вид| | |crossing| | | | | |last|
|cuisine|1|combo|Cuisine|Кухня| | |cuisine| | | | | |last|
|delivery|1|check|Delivery| | | |delivery| | | | | |last|
|denomination|1|combo|Denomination|Вероизповедание| | |denomination| | | | | |last|
|denotation|1|combo|Denotation|Название| | |denotation| | | | | |last|
...
|elevation|1|number|Elevation|Надморска височина|elevation|true|ele| | | | | |last|
|emergency|1|check|Emergency|Спешни случаи| | |emergency| | | | | |last|
|entrance|1|typeCombo|Type|Вид| | |entrance| | | | | |last|
|except|1|combo|Exceptions| | | |except| | | | | |last|
|fax|1|tel|Fax|Факс| | |fax| | | |+31 42 123 4567|+31 42 123 4567|last|
|fee|1|check|Fee|Такса| | |fee| | | | | |last|
...
|highway|1|typeCombo|Type|Вид| | |highway| | | | | |last|
|historic|1|typeCombo|Type|Вид| | |historic| | | | | |last|
|hoops|1|number|Hoops| | | |hoops| | | |1, 2, 4...| |last|
|iata|1|text|IATA|IATA| | |iata| | | | | |last|
|icao|1|text|ICAO|ICAO| | |icao| | | | | |last|
|incline|1|combo|Incline|Наклон| | |incline| | | | | |last|
|information|1|typeCombo|Type| | | |information| | | | | |last|
|internet_access|1|combo|Internet Access|Интернет достъп| | |internet_access|wlan|Yes|Wifi| | |last|
|internet_access|2|combo| | | | | |wired|No|Кабелен| | |last|
|internet_access|3|combo| | | | | |terminal|Wifi|Терминал| | |last|
...
|landuse|1|typeCombo|Type|Вид| | |landuse| | | | | |last|
|lanes|1|number|Lanes|Платна| | |lanes| | | |1, 2, 3...|1, 2, 3...|last|
|layer|1|combo|Layer|Слой| | |layer| | | | | |last|
|leisure|1|typeCombo|Type|Вид| | |leisure| | | | | |last|
|length|1|number|Length (Meters)| | | |length| | | | | |last|
|levels|1|number|Levels|Нива| | |building:levels| | | |2, 4, 6...|2, 4, 6...|last|
|lit|1|check|Lit| | | |lit| | | | | |last|
|location|1|combo|Location|Местоположение| | |location| | | | | |last|
|man_made|1|typeCombo|Type|Вид| | |man_made| | | | | |last|
|maxspeed|1|maxspeed|Speed Limit|Ограничение на скоростта| | |maxspeed| | | |40, 50, 60...|40, 50, 60...|last|
...
|name|1|localized|Name|Име| | |name| | | |Common name (if any)|Популярно наименование (ако има такова)|last|
|natural|1|typeCombo|Natural|Природа| | |natural| | | | | |last|
|network|1|text|Network|Мрежа| | |network| | | | | |last|
|note|1|textarea|Note|Бележка|note|true|note| | | | | |last|
|office|1|typeCombo|Type|Вид| | |office| | | | | |last|
|oneway|1|check|One Way|Еднопосочнoст| | |oneway| | | | | |last|
|oneway_yes|1|check|One Way|Еднопосочен| | |oneway| | | | | |last|
|opening_hours|1|text|Hours|Работно време| | |opening_hours| | | | | |last|
|operator|1|text|Operator|Оператор| | |operator| | | | | |last|
|par|1|number|Par| | | |par| | | |3, 4, 5...| |last|
|park_ride|1|check|Park and Ride|Буферен паркинг| | |park_ride| | | | | |last|
|parking|1|combo|Type|Вид| | |parking|surface|Surface|| | |last|
...
|place|1|typeCombo|Type|Вид| | |place| | | | | |last|
|population|1|text|Population| | | |population| | | | | |last|
|power|1|typeCombo|Type|Вид| | |power| | | | | |last|
|railway|1|typeCombo|Type|Вид| | |railway| | | | | |last|
...
|ref|1|text|Reference|Забележка| | |ref| | | | | |last|
|relation|1|combo|Type|Вид| | |type| | | | | |last|
|religion|1|combo|Religion|Религия| | |religion| | | | | |last|
|restriction|1|combo|Type|Вид| | |restriction| | | | | |last|
|restrictions|1|restrictions|Turn Restrictions| |restrictions| | | | | | | |last|
|route|1|combo|Type|Вид| | |route| | | | | |last|
|route_master|1|combo|Type|Вид| | |route_master| | | | | |last|
...
|service|1|combo|Type|Вид| | |service| | | | | |last|
...
|shelter|1|check|Shelter|Навес| | |shelter| | | | | |last|
|shelter_type|1|combo|Type| | | |shelter_type| | | | | |last|
|shop|1|typeCombo|Type|Вид| | |shop| | | | | |last|
...
|source|1|text|Source|Източник|source|true|source| | | | | |last|
|sport|1|combo|Sport|Спорт| | |sport| | | | | |last|
|sport_ice|1|combo|Sport| | | |sport| | | | | |last|
|sport_racing|1|combo|Sport| | | |sport| | | | | |last|
|structure|1|radio|Structure|Структура| | |bridge,tunnel,embankment,cutting,ford| | | |Unknown|Неизвестен|last|
|studio_type|1|combo|Type| | | |type| | | | | |last|
|substation|1|typeCombo|Type| | | |substation| | | | | |last|
|supervised|1|check|Supervised|Под наблюдение| | |supervised| | | | | |last|
|surface|1|combo|Surface|Повърхност| | |surface| | | | | |last|
...
|tourism|1|typeCombo|Type|Вид| | |tourism| | | | | |last|
|towertype|1|combo|Tower type|Вид кула| | |tower:type| | | | | |last|
...
|trail_visibility|1|combo|Trail Visibility|Видимост на туристическата пътека| | |trail_visibility|excellent|Excellent: unambiguous path or markers everywhere||Excellent, Good, Bad...| |last|
...
|water|1|combo|Type|Вид| | |water| | | | | |last|
|waterway|1|typeCombo|Type|Вид| | |waterway| | | | | |last|
|website|1|url|Website|Уебсайт|website|true|website| | | |http://example.com/|http://example.com/|last|
|wetland|1|combo|Type|Вид| | |wetland| | | | | |last|
|wheelchair|1|radio|Wheelchair Access|Достъп за инвалиди|wheelchair|true|wheelchair| | | | | |last|
|width|1|number|Width (Meters)| | | |width| | | | | |last|
|wikipedia|1|wikipedia|Wikipedia|Wikipedia|wikipedia|true|wikipedia| | | | | |last|
|wood|1|combo|Type|Вид| | |wood| | | | | |last|
