...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Akses| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Tidak diketahui|last|
|access_simple|1|combo|Access|Akses| | |access| | | |yes|iya|last|
|access_toilets|1|combo|Access|Akses| | |access| | | | | |last|
|address|1|address|Address|Alamat|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Tingkat Admin| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|Tipe| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|Akses| | |aerialway:access|entry|Entry|Masuk| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|Keluar| | |last|
|aerialway/access|3|combo| | | | | |both|Both|Keduanya| | |last|
|aerialway/bubble|1|check|Bubble| | | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|Kapasitas (perjam)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|Durasi (menit)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|Dipanaskan| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|Hunian| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)| | | |aerialway:summer:access|entry|Entry|Masuk| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|Keluar| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|Keduanya| | |last|
|aeroway|1|typeCombo|Type|Tipe| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|Tipe| | |amenity| | | | | |last|
|artist|1|text|Artist| | | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|Tipe| | |artwork_type| | | | | |last|
|atm|1|check|ATM|ATM| | |atm| | | | | |last|
|backrest|1|check|Backrest| | | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|Tipe| | |barrier| | | | | |last|
|bench|1|check|Bench| | | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|Tipe| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|Tipe| | |boundary| | | | | |last|
|building|1|typeCombo|Building|Bangunan| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|Bangunan| | |building| | | | | |last|
|capacity|1|number|Capacity|Kapasitas| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|Arah| | |direction|N|North|Utara| | |last|
|cardinal_direction|2|combo| | | | | |E|East|Timur| | |last|
|cardinal_direction|3|combo| | | | | |S|South|Selatan| | |last|
|cardinal_direction|4|combo| | | | | |W|West|Barat| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|Timur Laut| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|Tenggara| | |last|
...
|fire_hydrant/type|3|combo| | | | | |pond|Wall|Kolam| | |last|
...
|ref|1|text|Reference|Referensi| | |ref| | | | | |last|
...
|sport|1|combo|Sport|Olahraga| | |sport| | | | | |last|
...
|tree_type|1|combo|Type|Tipe| | |type| | | | | |last|
...
|width|1|number|Width (Meters)|Lebar (Meter)| | |width| | | | | |last|
