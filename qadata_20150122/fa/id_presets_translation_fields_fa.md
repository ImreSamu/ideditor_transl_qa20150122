...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|دسترسي| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|ناشناخته|last|
|access_simple|1|combo|Access|دسترسی| | |access| | | |yes| |last|
|access_toilets|1|combo|Access| | | |access| | | | | |last|
|address|1|address|Address|ادرس|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|سطح مدیریت| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|نوع| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|دسترسی| | |aerialway:access|entry|Entry|| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|| | |last|
|aerialway/access|3|combo| | | | | |both|Both|| | |last|
|aerialway/bubble|1|check|Bubble|قل قل کردن| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|ظرفیت (بر ساعت)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|مدت زمان (دقیقه)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|گرم شده| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|تصرف| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|دسترسی (تابستان)| | |aerialway:summer:access|entry|Entry|| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|| | |last|
|aeroway|1|typeCombo|Type|نوع| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|نوع| | |amenity| | | | | |last|
|artist|1|text|Artist|هنرمند| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|نوع| | |artwork_type| | | | | |last|
|atm|1|check|ATM|خودپرداز| | |atm| | | | | |last|
|backrest|1|check|Backrest|تکیه گاه| | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|نوع| | |barrier| | | | | |last|
|bench|1|check|Bench| | | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|نوع| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|نوع| | |boundary| | | | | |last|
|building|1|typeCombo|Building|ساختمان| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|ساختمان| | |building| | | | | |last|
|capacity|1|number|Capacity|ظرفيت| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|جهت| | |direction|N|North|| | |last|
...
|office|1|typeCombo|Type|نوع| | |office| | | | | |last|
...
|ref|1|text|Reference|مراجعتی| | |ref| | | | | |last|
...
|tree_type|1|combo|Type|نوع| | |type| | | | | |last|
...
|wood|1|combo|Type|نوع| | |wood| | | | | |last|
