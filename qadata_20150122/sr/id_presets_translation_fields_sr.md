...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|Приступ| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|Непознато|last|
|access_simple|1|combo|Access|Приступ| | |access| | | |yes|да|last|
|access_toilets|1|combo|Access|Приступ| | |access| | | | | |last|
|address|1|address|Address|Адреса|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Административни ниво| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|Врста| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|Приступ| | |aerialway:access|entry|Entry|Улаз| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|Излаз| | |last|
|aerialway/access|3|combo| | | | | |both|Both|| | |last|
|aerialway/bubble|1|check|Bubble| | | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|Капацитет (по сату)| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|Трајање (у минутама)| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|Грејано| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy| | | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|Приступ (лети)| | |aerialway:summer:access|entry|Entry|Улаз| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|Излаз| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|| | |last|
|aeroway|1|typeCombo|Type|Врста| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|Врста| | |amenity| | | | | |last|
|artist|1|text|Artist|Уметник| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|Врста| | |artwork_type| | | | | |last|
|atm|1|check|ATM|Банкомат| | |atm| | | | | |last|
|backrest|1|check|Backrest|Наслон за пецање| | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|Врста| | |barrier| | | | | |last|
|bench|1|check|Bench| | | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|Врста| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|Врста| | |boundary| | | | | |last|
|building|1|typeCombo|Building|Зграда| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|Зграда| | |building| | | | | |last|
|capacity|1|number|Capacity|Капацитет| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|Правац| | |direction|N|North|Север| | |last|
|cardinal_direction|2|combo| | | | | |E|East|Исток| | |last|
|cardinal_direction|3|combo| | | | | |S|South|Југ| | |last|
|cardinal_direction|4|combo| | | | | |W|West|Запад| | |last|
|cardinal_direction|5|combo| | | | | |NE|Northeast|Североисток| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|Југоисток| | |last|
