...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access| | | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown| |last|
|access_simple|1|combo|Access| | | |access| | | |yes| |last|
|access_toilets|1|combo|Access| | | |access| | | | | |last|
|address|1|address|Address|చిరునామా|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
...
|aeroway|1|typeCombo|Type|రకం| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|రకం| | |amenity| | | | | |last|
|artist|1|text|Artist| | | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|రకం| | |artwork_type| | | | | |last|
|atm|1|check|ATM| | | |atm| | | | | |last|
|backrest|1|check|Backrest| | | |backrest| | | | | |last|
|barrier|1|typeCombo|Type|రకం| | |barrier| | | | | |last|
|bench|1|check|Bench| | | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|రకం| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type|రకం| | |boundary| | | | | |last|
|building|1|typeCombo|Building|కట్టడం| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|కట్టడం| | |building| | | | | |last|
|capacity|1|number|Capacity|సామర్థ్యం| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|దిశ| | |direction|N|North|| | |last|
...
|clock_direction|1|combo|Direction|దిశ| | |direction|clockwise|Clockwise|| | |last|
...
|construction|1|combo|Type|రకం| | |construction| | | | | |last|
|country|1|combo|Country|దేశం| | |country| | | | | |last|
|covered|1|check|Covered| | | |covered| | | | | |last|
|craft|1|typeCombo|Type| | | |craft| | | | | |last|
|crop|1|combo|Crop| | | |crop| | | | | |last|
|crossing|1|combo|Type|రకం| | |crossing| | | | | |last|
...
|description|1|textarea|Description|వివరణ| | |description| | | | | |last|
...
|emergency|1|check|Emergency|అత్యవసరం| | |emergency| | | | | |last|
|entrance|1|typeCombo|Type|రకం| | |entrance| | | | | |last|
|except|1|combo|Exceptions| | | |except| | | | | |last|
|fax|1|tel|Fax| | | |fax| | | |+31 42 123 4567| |last|
|fee|1|check|Fee| | | |fee| | | | | |last|
|fire_hydrant/type|1|combo|Type|రకం| | |fire_hydrant:type|pillar|Pillar/Aboveground|| | |last|
...
|generator/type|1|combo|Type|రకం| | |generator:type| | | | | |last|
|golf_hole|1|text|Reference| | | |ref| | | |Hole number (1-18)| |last|
|handicap|1|number|Handicap| | | |handicap| | | |1-18| |last|
|highway|1|typeCombo|Type|రకం| | |highway| | | | | |last|
|historic|1|typeCombo|Type|రకం| | |historic| | | | | |last|
...
|internet_access|1|combo|Internet Access| | | |internet_access|yes|Yes|| | |last|
...
|landuse|1|typeCombo|Type|రకం| | |landuse| | | | | |last|
|lanes|1|number|Lanes| | | |lanes| | | |1, 2, 3...|1, 2, 3...|last|
|layer|1|combo|Layer|పొర| | |layer| | | | | |last|
|leisure|1|typeCombo|Type|రకం| | |leisure| | | | | |last|
|length|1|number|Length (Meters)| | | |length| | | | | |last|
|levels|1|number|Levels|స్థాయిలు| | |building:levels| | | |2, 4, 6...| |last|
|lit|1|check|Lit| | | |lit| | | | | |last|
|location|1|combo|Location| | | |location| | | | | |last|
|man_made|1|typeCombo|Type|రకం| | |man_made| | | | | |last|
|maxspeed|1|maxspeed|Speed Limit|వేగ పరిమితి| | |maxspeed| | | |40, 50, 60...| |last|
...
|name|1|localized|Name|పేరు| | |name| | | |Common name (if any)|మామూలు పేరు (ఉంటే)|last|
|natural|1|typeCombo|Natural| | | |natural| | | | | |last|
|network|1|text|Network| | | |network| | | | | |last|
|note|1|textarea|Note|గమనిక|note|true|note| | | | | |last|
|office|1|typeCombo|Type|రకం| | |office| | | | | |last|
|oneway|1|check|One Way| | | |oneway| | | | | |last|
|oneway_yes|1|check|One Way| | | |oneway| | | | | |last|
|opening_hours|1|text|Hours|గంటలు| | |opening_hours| | | | | |last|
|operator|1|text|Operator| | | |operator| | | | | |last|
|par|1|number|Par| | | |par| | | |3, 4, 5...| |last|
|park_ride|1|check|Park and Ride| | | |park_ride| | | | | |last|
|parking|1|combo|Type|రకం| | |parking|surface|Surface|| | |last|
...
|phone|1|tel|Phone|ఫోన్|telephone|true|phone| | | |+31 42 123 4567| |last|
...
|place|1|typeCombo|Type|రకం| | |place| | | | | |last|
|population|1|text|Population| | | |population| | | | | |last|
|power|1|typeCombo|Type|రకం| | |power| | | | | |last|
|railway|1|typeCombo|Type|రకం| | |railway| | | | | |last|
...
|relation|1|combo|Type|రకం| | |type| | | | | |last|
|religion|1|combo|Religion|మతం| | |religion| | | | | |last|
|restriction|1|combo|Type|రకం| | |restriction| | | | | |last|
|restrictions|1|restrictions|Turn Restrictions| |restrictions| | | | | | | |last|
|route|1|combo|Type|రకం| | |route| | | | | |last|
|route_master|1|combo|Type|రకం| | |route_master| | | | | |last|
...
|service|1|combo|Type|రకం| | |service| | | | | |last|
...
|shop|1|typeCombo|Type|రకం| | |shop| | | | | |last|
...
|source|1|text|Source|మూలం|source|true|source| | | | | |last|
|sport|1|combo|Sport|క్రీడ| | |sport| | | | | |last|
...
|surface|1|combo|Surface|ఉపరితలం| | |surface| | | | | |last|
...
|tourism|1|typeCombo|Type|రకం| | |tourism| | | | | |last|
...
|water|1|combo|Type|రకం| | |water| | | | | |last|
|waterway|1|typeCombo|Type|రకం| | |waterway| | | | | |last|
|website|1|url|Website|జాలగూడు|website|true|website| | | |http://example.com/| |last|
|wetland|1|combo|Type|రకం| | |wetland| | | | | |last|
|wheelchair|1|radio|Wheelchair Access| |wheelchair|true|wheelchair| | | | | |last|
|width|1|number|Width (Meters)| | | |width| | | | | |last|
|wikipedia|1|wikipedia|Wikipedia|వికీపీడియా|wikipedia|true|wikipedia| | | | | |last|
|wood|1|combo|Type|రకం| | |wood| | | | | |last|
