...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|通行制限| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|その他|last|
|access_simple|1|combo|Access|通行制限| | |access| | | |yes|可|last|
|access_toilets|1|combo|Access|利用対象| | |access| | | | | |last|
|address|1|address|Address|住所|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|Admin Level| | |admin_level| | | | | |last|
|aerialway|1|typeCombo|Type|タイプ| | |aerialway| | | | | |last|
|aerialway/access|1|combo|Access|乗降場所| | |aerialway:access|entry|Entry|入口| | |last|
|aerialway/access|2|combo| | | | | |exit|Exit|出口| | |last|
|aerialway/access|3|combo| | | | | |both|Both|両方| | |last|
|aerialway/bubble|1|check|Bubble|覆い| | |aerialway:bubble| | | | | |last|
|aerialway/capacity|1|number|Capacity (per hour)|運搬人数（1時間当たり）| | |aerialway:capacity| | | |500, 2500, 5000...|500, 2500, 5000...|last|
|aerialway/duration|1|number|Duration (minutes)|所用時間（分）| | |aerialway:duration| | | |1, 2, 3...|1, 2, 3...|last|
|aerialway/heating|1|check|Heated|暖房| | |aerialway:heating| | | | | |last|
|aerialway/occupancy|1|number|Occupancy|重量| | |aerialway:occupancy| | | |2, 4, 8...|2, 4, 8...|last|
|aerialway/summer/access|1|combo|Access (summer)|乗降場所（夏季）| | |aerialway:summer:access|entry|Entry|入口| | |last|
|aerialway/summer/access|2|combo| | | | | |exit|Exit|出口| | |last|
|aerialway/summer/access|3|combo| | | | | |both|Both|両方| | |last|
|aeroway|1|typeCombo|Type|形態| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|種類| | |amenity| | | | | |last|
|artist|1|text|Artist|アーティスト| | |artist_name| | | | | |last|
|artwork_type|1|combo|Type|タイプ| | |artwork_type| | | | | |last|
...
|cardinal_direction|5|combo| | | | | |NE|Northeast|北東| | |last|
|cardinal_direction|6|combo| | | | | |SE|Southeast|南東| | |last|
