...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
|access|1|access|Access|通行限制| | |access,foot,motor_vehicle,bicycle,horse| | | |Unknown|未知种类|last|
|access_simple|1|combo|Access| | | |access| | | |yes| |last|
|access_toilets|1|combo|Access| | | |access| | | | | |last|
|address|1|address|Address|地址|address|true|addr:housename,addr:housenumber,addr:street,addr:city,addr:postcode| | | | | |last|
|admin_level|1|number|Admin Level|管理级别| | |admin_level| | | | | |last|
...
|aeroway|1|typeCombo|Type|类型| | |aeroway| | | | | |last|
|amenity|1|typeCombo|Type|类型| | |amenity| | | | | |last|
...
|barrier|1|typeCombo|Type|类型| | |barrier| | | | | |last|
|bench|1|check|Bench| | | |bench| | | | | |last|
|bicycle_parking|1|combo|Type|类型| | |bicycle_parking| | | | | |last|
|boundary|1|combo|Type| | | |boundary| | | | | |last|
|building|1|typeCombo|Building|建筑物| | |building| | | | | |last|
|building_area|1|defaultcheck|Building|建筑物| | |building| | | | | |last|
|capacity|1|number|Capacity|容量| | |capacity| | | |50, 100, 200...|50, 100, 200...|last|
|cardinal_direction|1|combo|Direction|方向| | |direction|N|North|| | |last|
...
|cuisine|1|combo|Cuisine|美食| | |cuisine| | | | | |last|
...
|emergency|1|check|Emergency|急诊| | |emergency| | | | | |last|
...
|internet_access|1|combo|Internet Access|互联网接入| | |internet_access|wlan|Yes|无线网络| | |last|
|internet_access|2|combo| | | | | |wired|No|有线网络| | |last|
|internet_access|3|combo| | | | | |terminal|Wifi|终端| | |last|
...
|layer|1|combo|Layer|层| | |layer| | | | | |last|
|leisure|1|typeCombo|Type|类型| | |leisure| | | | | |last|
|length|1|number|Length (Meters)| | | |length| | | | | |last|
|levels|1|number|Levels|级别| | |building:levels| | | |2, 4, 6...|2, 4, 6...|last|
...
|name|1|localized|Name|名称| | |name| | | |Common name (if any)|常用名称（如有）|last|
...
|oneway|1|check|One Way|单行| | |oneway| | | | | |last|
|oneway_yes|1|check|One Way|单行| | |oneway| | | | | |last|
|opening_hours|1|text|Hours|小时| | |opening_hours| | | | | |last|
...
|parking|1|combo|Type|类型| | |parking|surface|Surface|| | |last|
...
|phone|1|tel|Phone|手机|telephone|true|phone| | | |+31 42 123 4567|+31 42 123 4567|last|
...
|trail_visibility|1|combo|Trail Visibility|路径可见度| | |trail_visibility|excellent|Excellent: unambiguous path or markers everywhere||Excellent, Good, Bad...| |last|
